...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->LastNameSuperior->Click += gcnew System::EventHandler(this, &UpdateClient::label2_Click);
			// 
			// tbLNS
			// 
			...
			this->FirstName->Click += gcnew System::EventHandler(this, &UpdateClient::label5_Click);
			// 
			// LastName
			// 
			...
			this->CityName->Click += gcnew System::EventHandler(this, &UpdateClient::label8_Click);
			// 
			// StreetName
			// 
			...
			this->label2->Click += gcnew System::EventHandler(this, &UpdateClient::label2_Click_1);
			// 
			// tbIdClient
			// 
			this->tbIdClient->Location = System::Drawing::Point(316, 195);
			this->tbIdClient->Name = L"tbIdClient";
			this->tbIdClient->Size = System::Drawing::Size(379, 38);
			this->tbIdClient->TabIndex = 25;
			// 
			// label3
			// 
			...
			this->label3->Text = L"Address Client";
			// 
			// panel1
			// 
	...
	private: System::Void btnOK_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		try {
			...
			try {
				...
				if (Int32::TryParse(this->tbIdClient->Text, personId)) {
