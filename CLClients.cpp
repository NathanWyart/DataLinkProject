...
CLAddress^ CLClients::getdelivery_address(CLAddress^ delivery_address) {
	return this->delivery_address;
}

CLAddress^ CLClients::getbilling_address(CLAddress^ billing_address) {
	return this->billing_address;
}

System::String^ CLClients::getdate_first_order(System::String^ date_first_order) {
